...
{
  {
    V3S_IO_SECTION_PA, V3S_IO_SECTION_VA,
    MMU_IOFLAGS, _NSECTIONS(V3S_IO_SECTION_SIZE)
  },
  {
    V3S_CODE_SECTION_PA, V3S_CODE_SECTION_VA,
    MMU_MEMFLAGS, _NSECTIONS(V3S_CODE_SECTION_SIZE)
  },
  {
  ...
  //   MMU_IOFLAGS, _NSECTIONS(V3S_DMA_SECTION_SIZE)
  // },
};
